...
## [0.1.1](https://github.com/DarkRader/fastapi-template/compare/v0.1.0...v0.1.1) (2026-06-11)
...
* **deps:** update dependency pytest-cov to v7.1.0 ([f1e2eb2](https://github.com/DarkRader/fastapi-template/commit/f1e2eb2d54661db1b7e744efa183ffbdac7d86bb))
* **deps:** update dependency pytest-cov to v7.1.0 ([#21](https://github.com/DarkRader/fastapi-template/issues/21)) ([a12ad07](https://github.com/DarkRader/fastapi-template/commit/a12ad07d9bcae3f41dd709b15f9d9c5d3f66b5d8))
...
* **deps:** update dependency ruff to v0.15.12 ([14ee81a](https://github.com/DarkRader/fastapi-template/commit/14ee81a89f73ee20eeec8fe41d0270e1bc157948))
* **deps:** update dependency ruff to v0.15.12 ([#13](https://github.com/DarkRader/fastapi-template/issues/13)) ([eb53bd5](https://github.com/DarkRader/fastapi-template/commit/eb53bd5a98f1ba4123268aae2c9ce0750f832d86))
* **deps:** update dependency types-python-dateutil to v2.9.0.20260508 ([ae43b21](https://github.com/DarkRader/fastapi-template/commit/ae43b21cbfc2c6edbd076c95633ada3b3e57eef5))
* **deps:** update dependency types-python-dateutil to v2.9.0.20260508 ([#22](https://github.com/DarkRader/fastapi-template/issues/22)) ([692f393](https://github.com/DarkRader/fastapi-template/commit/692f3937376ed0fdec3c443e81ba2113e9a745f6))
...
* **deps:** update ghcr.io/astral-sh/uv docker tag to v0.11.14 ([0402ab1](https://github.com/DarkRader/fastapi-template/commit/0402ab1864be7e6034579154d06a078e2fd6a912))
* **deps:** update ghcr.io/astral-sh/uv docker tag to v0.11.14 ([#20](https://github.com/DarkRader/fastapi-template/issues/20)) ([8398069](https://github.com/DarkRader/fastapi-template/commit/839806958a6b77928b78e087c8b94e72cbc634d5))
...
* **renovate:** update config ([efe1310](https://github.com/DarkRader/fastapi-template/commit/efe131014bdb0e9ca06b61df44e9b0e981e3851e))
* update dependecies ([da2e67f](https://github.com/DarkRader/fastapi-template/commit/da2e67f7a34f8ca9a1af3b5fe17abca189a8dd56))
* update libs and migrate to mypy v2 ([eb0c730](https://github.com/DarkRader/fastapi-template/commit/eb0c730f0c850b243c93c1c948627705ba45b2de))
...
* **deps:** update dependency aiohttp to v3.13.5 ([f487379](https://github.com/DarkRader/fastapi-template/commit/f48737977eca68237146f67e804455510cba15e9))
* **deps:** update dependency aiohttp to v3.13.5 ([#23](https://github.com/DarkRader/fastapi-template/issues/23)) ([1115fa8](https://github.com/DarkRader/fastapi-template/commit/1115fa8acb1b433e6a2aa40fdcbf232dd104a8f0))
* **deps:** update dependency pytest to v9.0.3 ([b34d470](https://github.com/DarkRader/fastapi-template/commit/b34d4702260bdc9fc3904e3d4df5c0ec125495e8))
* **deps:** update dependency pytest to v9.0.3 ([#24](https://github.com/DarkRader/fastapi-template/issues/24)) ([d0cdab8](https://github.com/DarkRader/fastapi-template/commit/d0cdab8ed2534779fd6ab62ac450bd863d4a4071))
...
* **deps:** update dependency uvicorn to v0.46.0 ([b8aa85b](https://github.com/DarkRader/fastapi-template/commit/b8aa85be45bc560df0ab0f937265ff6175cf097a))
* **deps:** update dependency uvicorn to v0.46.0 ([#19](https://github.com/DarkRader/fastapi-template/issues/19)) ([85b8385](https://github.com/DarkRader/fastapi-template/commit/85b8385bcc0e05a9d0907c581f280500a94b8db9))
...
* same behave for .env vars in docker and local machine ([5baab2e](https://github.com/DarkRader/fastapi-template/commit/5baab2ecf4115c16494fb04ae654211072ff5ecb))
