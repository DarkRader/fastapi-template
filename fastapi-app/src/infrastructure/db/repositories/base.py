"""
SQLAlchemy implementation of the CRUD repository port.

This class adapts the generic CRUDBase port to SQLAlchemy, handling
actual database operations asynchronously. Services depend on the CRUDBase
...
class SQLAlchemyCRUDBase(CRUDBase[Model, CreateSchema, UpdateSchema]):
    """Adapter implementing CRUDBase with SQLAlchemy."""
